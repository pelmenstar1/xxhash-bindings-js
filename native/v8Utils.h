...
std::optional<uint32_t> V8GetUInt32Optional(v8::Isolate* isolate, v8::Local<v8::Value> optValue, uint32_t ifUndefined);
std::optional<uint64_t> V8GetUInt64Optional(v8::Isolate* isolate, v8::Local<v8::Value> optValue, uint64_t ifUndefined);

...
import lib, { XxHashState, XxVariantName } from 'xxhash-bindings';
import { variantNames } from './utils';
...
function forEachNoSeedState(
  createState: Lib[XxVariantName]['createState'],
...
test.each<[XxVariantName, number | bigint, number | bigint]>([
